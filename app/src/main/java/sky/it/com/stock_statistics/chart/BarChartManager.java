 ...
 * @company Name:
 * @author: sky
 * @creatDate: 2019/3/31 3:14 PM
 * @className: BarChartManager
 * @description:
 * 参考链接： https://blog.csdn.net/android_cmos/article/details/76794121
 * @modified By:
 * @modifyDate:
 */
...
//        colors.add(Color.CYAN);
        ...
        colors.add(Color.parseColor("#65C8CA"));
        colors.add(Color.parseColor("#F6BE42"));
        colors.add(Color.parseColor("#EF8671"));
        colors.add(Color.parseColor("#F8CD46"));
        initBarChart();
    }
    ...
    private void initBarChart() {
        ...
        //虚线
        leftAxis.enableGridDashedLine(6f, 3f, 0);
